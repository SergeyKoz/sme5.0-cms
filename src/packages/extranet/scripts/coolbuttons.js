...
function doOver(e) {
	if (!e) e=window.event;
	var toEl = getReal( e.relatedTarget || e.toElement, "className", "coolButton");
	var fromEl = getReal( e.relatedTarget || e.fromElement, "className", "coolButton");
...
function doDown(e) {
	if (!e) e=window.event;
	el = getReal(e.target || e.srcElement, "className", "coolButton");
