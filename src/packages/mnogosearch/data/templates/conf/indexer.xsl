...
# Note: this cache is allocated for all DBAddr, so if you have 3 DBAddr
#       commands and WordCacheSize is 10Mb, it could take up to 30Mb.
...
#########################################################################
#ServerWeight <number>
# Server weight for Popularity Rank calculation. Default value is 1.
#ServerWeight 1
{ServerWeight}
...
# Skip links from same site for Popularity Rank calculation. Default value is "no".
