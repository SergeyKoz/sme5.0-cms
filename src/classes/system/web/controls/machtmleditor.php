...
/** MacHtmlEditorControl control
     ...
     * @access public
     */
    class MacHtmlEditorControl extends TextAreaControl {
        var $ClassName = "MacHtmlEditorControl";
        var $Version = "1.0";
        /**
   ...
   */
        function XmlControlOnRender(&$xmlWriter) {
         ...
         $xmlWriter->WriteStartElement("machtmleditor");
