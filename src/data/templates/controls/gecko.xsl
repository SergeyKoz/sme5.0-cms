 // control registration array
  ...
  {
    var wnd = window.open('<xsl:value-of select="spaw_dir" />dialogs/colorpicker.php?lang=' 
  ...
  function SPAW_hyperlink_click(editor, sender)
  {
    ...
    var wnd = window.open('<xsl:value-of select="spaw_dir" />dialogs/a.php?lang=' 
      + document.getElementById('SPAW_'+editor+'_lang').value + '&theme=' 
      + document.getElementById('SPAW_'+editor+'_theme').value
 ...
 /***********************/
  ...
  {
    var wnd = window.open('<xsl:value-of select="spaw_dir" />dialogs/img_library.php?lang=' 
      + document.getElementById('SPAW_'+editor+'_lang').value + '&theme=' 
      + document.getElementById('SPAW_'+editor+'_theme').value
  ...
  function SPAW_image_prop_click(editor, sender)
  {
    ...
    if (im)
    {
      ...
      var wnd = window.open('<xsl:value-of select="spaw_dir" />dialogs/img.php?lang=' 
        + document.getElementById('SPAW_'+editor+'_lang').value + '&theme=' 
        + document.getElementById('SPAW_'+editor+'_theme').value
  ...
  function SPAW_image_popup_click_callback(editor, sender)
  {
    ...
    if(imgSrc != null)    
    {
      if (a)
      {
        // edit hyperlink
        a.href="#";
        a.setAttribute("onclick","window.open('<xsl:value-of select="spaw_dir" />?img_url="+imgSrc+"','Image','width=500,height=300,scrollbars=no,toolbar=no,location=no,status=no,resizable=yes,screenX=120,screenY=100');return false;");
      }
      else
      {
        var a;
  ...
  {
      var wnd = window.open('<xsl:value-of select="spaw_dir" />dialogs/table.php?lang=' 
      + document.getElementById('SPAW_'+editor+'_lang').value + '&theme=' 
      + document.getElementById('SPAW_'+editor+'_theme').value
  ...
  function SPAW_table_cell_prop_click(editor, sender)
  {
    ...
    if (cd)
    {
      ...
      var wnd = window.open('<xsl:value-of select="spaw_dir" />dialogs/td.php?lang=' 
      + document.getElementById('SPAW_'+editor+'_lang').value + '&theme=' 
      + document.getElementById('SPAW_'+editor+'_theme').value
