<?php
        ...
        $mcFileManagerConfig['general.plugins'] = "History,Favorites,SMEngineAuthenticator"; // comma seperated
        ...
        $mcFileManagerConfig['filesystem.rootpath'] = ''; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,xls";
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,txt,swf,doc,xls,avi,flv";
